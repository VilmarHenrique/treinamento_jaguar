...
var gsOutOfRange="Desculpe, A data Indicada está abaixo do limite permitido (1950)!";	// out-of-date-range error message. If set to "", no alerts will popup on such error.
