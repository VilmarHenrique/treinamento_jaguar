	...
	$.reject = function(opts) {
		var opts = $.extend(true,{
			reject : { // Rejection flags for specific browsers
				...
				msie: true,msie5: true,msie6: true,msie7: true,msie8: true,msie9: true // MSIE Flags (Global, 5-8)
				/*
					Possibilities are endless...

					msie: true,msie5: true,msie6: true,msie7: true,msie8: true, // MSIE Flags (Global, 5-8)
					firefox: true,firefox1: true,firefox2: true,firefox3: true, // Firefox Flags (Global, 1-3)
					...
					opera: true,opera7: true,opera8: true,opera9: true,opera10: true, // Opera Flags (Global, 7-10)
			...
			header: 'Seu navegador não é compatível com esse Sistema.', // Header of pop-up window
			paragraph1: 'Abaixo estão os navegadores que possuem compatibilidade.', // Paragraph 1
			paragraph2: 'Apenas clique no ícone para fazer o download', // Paragraph 2
			close: true, // Allow closing of window
			closeMessage: 'Fechando essa janela o uso do sistema pode ficar comprometido.', // Message displayed below closing link
			closeLink: 'Fechar Janela', // Text for closing link
			closeURL: '#', // Close URL
			...
			imagePath: 'lib/jaguar/jquery/img/', // Path where images are located
		...
		if (opts.display.length < 1) opts.display = ['firefox','chrome'];
