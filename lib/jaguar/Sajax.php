...
/*
  * Distribuited as part of the jaguar package.
  @copyright http://www.modernmethod.com/sajax/
*/
...
if (!isset($SAJAX_INCLUDED))
{
  ...
  function sajax_get_js_repr($value) 
  {
    ...
    switch ($type)
    {
      case "boolean": return ($value) ? "Boolean(true)" : "Boolean(false)"; break;
      ...
      default: return "'" . sajax_esc($value)  . "'"; break;
    }
  }
